...
import {columnsDataColumns} from "views/admin/dataTables/variables/columnsData.js";
...
import {runSshCommand} from 'opensand/redux/ssh.ts';
import {combineActions} from 'opensand/utils/actions.ts';
...
import Network from 'views/admin/Network/Network';

import { Portal, Box, useDisclosure, Text, Button, Link, SimpleGrid } from '@chakra-ui/react';
...
const Project: React.FC<Props> = (props) => {
    ...
    const actions = React.useMemo(() => combineActions([
        ...
        {path: ['configuration', 'topology__template'], actions: {onRemove: handleDelete}},
        {path: ['configuration', 'entities', 'item', 'profile__template'], actions: { onRemove: handleDelete}},
        {path: ['configuration', 'entities', 'item', 'infrastructure__template'], actions: { onRemove: handleDelete}},
    ]), [handleOpen, handleDeleteEntity, handleDelete]);
	...
	const getActiveRoute = (routes: string | any[],nameProject: undefined | string) => {
